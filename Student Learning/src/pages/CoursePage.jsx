    ...
    const fetchTopics = async () => {
      if (course && !course.topics?.length) {
        ...
        try {
          ...
          updateTopics(course.id, topics.map((t, i) => ({ ...t, id: i })));
        } catch (error) {
  ...
  return (
    <div className="max-w-6xl mx-auto mt-10 p-6">
      <div className="mb-8 flex justify-between items-center">
        ...
        {course.topics?.every(topic => topic.completed) && (
          <Link
            to={`/course/${course.id}/final-test`}
          ...
          >
            ...
            <span className="text-sm">(50 Questions)</span>
          </Link>
        )}
      </div>
